                            ...
                            <div class="btn-toolbar justify-content-between">
                                <div class="form-row">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control form-control-sm selectric" name="filter_obat" id="filter_obat">
                                            <option selected="selected" value="">-- Obat --</option>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function loaddata(page, cari, jml, obat) {
            $.ajax({
                url: urlx + '/data',
                data: {
                    "page": page,
        ...
        function loadpage(cari, jml, obat) {
            $.ajax({
                url: urlx + '/data',
                data: {
                    "cari": cari,
        ...
        $("#pencarian, #jumlah, #filter_obat").on('keyup change', function(event) {
            let cari = $('#pencarian').val();
            let jml = $('#jumlah').val();
            let obat = $('#filter_obat').val();
            loadpage(cari, jml, obat);
        });
    ...
    function formPdf(pdf) {
        window.open("{{url('pdf')}}/" + pdf, '_blank');
    }
</script>
@endpush